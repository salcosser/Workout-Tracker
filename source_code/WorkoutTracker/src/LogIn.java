...
public class LogIn {
	 ...
	 * 
	 * Unless otherwise specified, the majority of the following code was auto-generated by the design interface built into eclipse.
	 */
	...
	private void initialize() {
		...
		Login.getContentPane().setBackground(new Color(0, 191, 255));
		...
		btnLIn.addActionListener(new ActionListener() {
			// setting up variables to be used in the sign in process
		...
		JLabel lblPleaseHaveAn = new JLabel("Please have an active connection to MySQL running before logging in");
		lblPleaseHaveAn.setHorizontalAlignment(SwingConstants.CENTER);
		lblPleaseHaveAn.setBounds(17, 236, 392, 14);
		Login.getContentPane().add(lblPleaseHaveAn);
	}
